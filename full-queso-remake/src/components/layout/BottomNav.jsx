...
import { FiHome, FiTag, FiClipboard, FiUser, FiShoppingCart, FiStar } from 'react-icons/fi'
...
const BottomNav = () => {
    ...
    return (
            <>
                <nav className='fixed bottom-0 left-0 right-0 bg-white border-t border-neutral-border h-16 md:hidden'>
                    <div className='flex justify-around items-center h-full'>
                        ...
                        style={({ isActive }) => isActive ? activeLinkStyle : undefined}>
                            ...
                            <FiStar size={24} />
                            <span className='text-xs font-body'>Full Pana</span>
                        </NavLink>
                ...
                {totalItems > 0 && (
                    <NavLink to='/carrito' className='fixed bottom-20 md:bottom-6 right-6 z-50 bg-brand-primary text-white rounded-full p-4 shadow-lg flex items-center justify-center transform hover:scale-110 transition-transform duration-200'>
                        ...
                        <span className='absolute -top-1 -right-1 h-6 w-6 rounded-full bg-brand-primary-dark text-white text-sm font-bold flex items-center justify-center border-2 border-white dark:border-slate-800'> {totalItems} </span>
                    </NavLink>
                )}
